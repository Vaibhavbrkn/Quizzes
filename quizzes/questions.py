...
class Question:
    ...
    def __build_questions(self, data, min_question, max_question, total_min, total_max):
        ...
        for key in list1:
            ...
            outs = self.model.generate(input_ids=source_tokenizer['input_ids'].to(self.device), attention_mask=source_tokenizer['attention_mask'].to(self.device), max_length=50)
